...
const {userStore:{favoriteUser},postStore:{favoritePost},commentStore:{favoriteComment}} =useStore();
    return (
        <div className={'header'}>
            ...
            {favoriteComment && <div className={'favoriteUser'}>Favorite comment:{favoriteComment.name}</div>}
        </div>
    );
};
